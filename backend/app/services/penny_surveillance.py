...
PENNY_STOCK_MASTER: Dict[str, Dict] = {
    # Clean Candidates (Pass survival filters: Price ₹5-₹50, 10% or 20% bands, 0 ASM/GSM/ESM)
    "YESBANK": {
        "name": "Yes Bank Ltd.",
        "exchange": "NSE",
        "series": "EQ",
    ...
    "RPOWER": {
        ...
        "esm_stage": 0,
        "asm_stage": 0,
        "daily_trades_avg": 42000,
        "bid_ask_spread_pct": 0.22,
    },
    "JPPOWER": {
    ...
    "ALOKINDS": {
        ...
        "esm_stage": 0,
        "asm_stage": 0,
        "daily_trades_avg": 24000,
        "bid_ask_spread_pct": 0.35,
    },
    "URJA": {
